      ...
      <div className="w-full max-w-lg">
        ...
        <div className="bg-slate-800 rounded-2xl p-8 border border-slate-700">
          ...
          <div className="flex items-center justify-between mb-6">
            <span className="text-white font-medium">Auto-Identify Tracks (Every Minute)</span>
            <button
          ...
          {identificationStatus && (
            <div className="text-center">
              <div className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium ${
                isIdentifying ? 'bg-orange-500/20 text-orange-400' :
                identificationStatus.includes('Found:') ? 'bg-green-500/20 text-green-400' :
                'bg-slate-600/20 text-slate-300'
              }`}>
                {isIdentifying && <div className="w-4 h-4 border-2 border-orange-400 border-t-transparent rounded-full animate-spin mr-2"></div>}
                {identificationStatus}
              </div>
            </div>
          )}
        ...
        {identifiedTracks.length > 0 && (
          <div className="mt-8">
            <h3 className="text-xl font-bold text-white mb-4">Recent Identifications</h3>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-slate-500 text-sm">
                      {new Date(track.timestamp).toLocaleTimeString('en-IE', {
