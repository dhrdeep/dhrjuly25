...
export default function DragonPage() {
  ...
  const captureStreamAudio = useCallback(async () => {
    try {
      ...
      // Use exact settings from working system that generates 402KB files
      const mediaRecorder = new MediaRecorder(destination.stream, {
        mimeType: 'audio/webm;codecs=opus',
        audioBitsPerSecond: 320000 // Increase bitrate to match 402KB target file size
      });
      ...
      mediaRecorder.onstop = async () => {
        ...
        try {
          ...
          console.log('Using direct client-side ACRCloud approach like working system...');
          
          // Try ACRCloud first with direct client approach
